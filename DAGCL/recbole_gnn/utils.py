...
def get_trainer(model_type, model_name):
    ...
    try:
        ...
        if getattr(model_type, "name", None) == "GENERAL" or str(model_type).upper().endswith("GENERAL"):
            return getattr(importlib.import_module('recbole_gnn.trainer'), 'DAGCLTrainer')
